...
const TestimonialCard = ({ 
  ...
  return (
    ...
    >
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-violet-50 via-white to-purple-50 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      
      {/* Main content */}
      <div className="relative p-8">
        {/* Quote icon */}
        <div className="absolute -top-4 left-8 w-8 h-8 bg-gradient-to-br from-violet-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg">
...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-purple-50">
            ...
            <div className="relative lg:pl-8 mt-12 lg:mt-0">
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -left-4 sm:-left-8 top-16 sm:top-20 bg-white p-3 sm:p-4 rounded-xl shadow-lg border border-violet-100 backdrop-blur-sm hidden sm:block"
                >
                  <div className="flex items-center space-x-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-violet-100 rounded-full flex items-center justify-center">
                ...
                <motion.div
                  ...
                  className="absolute -right-4 sm:-right-8 bottom-24 sm:bottom-32 bg-white p-3 sm:p-4 rounded-xl shadow-lg border border-purple-100 backdrop-blur-sm hidden sm:block"
                >
                  <div className="flex items-center space-x-2">
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-violet-50">
      ...
      {/* Enhanced Testimonials Section with Infinite Moving Cards */}
      <section className="py-16 sm:py-24 bg-gradient-to-b from-violet-50 via-white to-purple-50 relative overflow-hidden">
        {/* Background decorative elements */}
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-violet-200 to-purple-200 rounded-full opacity-20 blur-xl"></div>
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-purple-200 to-violet-200 rounded-full opacity-15 blur-xl"></div>
        ...
        <div className="container mx-auto px-4 relative">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-violet-100 to-purple-100 px-6 py-3 rounded-full mb-8 shadow-lg">
              <Heart className="h-5 w-5 text-violet-600" />
              <span className="text-violet-700 font-semibold">Community Love</span>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-r from-violet-500 via-purple-600 to-violet-600 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-violet-100 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4">
              <Button 
                size="lg" 
                className="bg-white text-violet-600 hover:bg-violet-50 px-6 sm:px-10 py-4 sm:py-6 text-base sm:text-lg font-semibold shadow-2xl hover:shadow-3xl transition-all duration-300 group"
              >
                Get Started Free
