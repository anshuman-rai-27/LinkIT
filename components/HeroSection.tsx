...
const HeroSection = () => {
  ...
  return (
    <section className={`relative flex flex-col items-center justify-center py-20 md:py-32 bg-gradient-to-br from-white to-[#f5f6ff] overflow-hidden transition-all duration-700 ${show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 bg-white/90 shadow-lg rounded-2xl px-6 py-4 w-full max-w-3xl mb-4">
          ...
          <button className="bg-gradient-to-r from-pink-500 to-purple-500 text-white font-semibold px-5 py-2 rounded-xl shadow hover:from-pink-600 hover:to-purple-600 transition-all mr-2">
            Filters
          </button>
          <button className="bg-gradient-to-r from-blue-400 to-cyan-400 text-white font-semibold px-5 py-2 rounded-xl shadow hover:from-blue-500 hover:to-cyan-500 transition-all">
            Search
          </button>
        </div>
      </div>
